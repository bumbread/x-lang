        ...
        if(*state->stream == '=') { // >=
          ...
          if(*state->stream == '>') { // >>>
            ...
            if(*state->stream == '=') { // >>>= 
              state->offset += 1;
              state->stream += 1;
              state->last_token.kind = TOKEN_OP_ASHIFTR_ASSIGN;
            }
            ...
            state->offset += 1;
            state->stream += 1;
            state->last_token.kind = TOKEN_OP_LSHIFTR_ASSIGN;
          }
        ...
        if(*state->stream == '=') { // <=
          ...
          if(*state->stream == '<') { // <<<
            ...
            if(*state->stream == '=') { // <<<=
              state->offset += 1;
              state->stream += 1;
              state->last_token.kind = TOKEN_OP_ASHIFTL_ASSIGN;
            }
            ...
            state->offset += 1;
            state->stream += 1;
            state->last_token.kind = TOKEN_OP_LSHIFTL_ASSIGN;
          }
